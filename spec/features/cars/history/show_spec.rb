...
describe Car do
  ...
  describe "Cars#show" do 
    ...
    skip "Should show the exact positions between two dates (and previous or later dates)" do
      visit car_path(@car) 
    ...
    skip "Should show some positions by default" do
      visit car_path(@car) 
      expect(page).to_not have_content("No positions available for this period") 
      expect(page).to have_content("Address")
    end

    skip "Should list positions when user select period where there was positions" do
      visit car_path(@car) 
      fill_in "dates_start_date", with: "4/12/2014"
      fill_in "dates_start_time", with: "08:15"
      fill_in "dates_end_date", with: "4/12/2014"
    ...
    skip "Shouldn't list positions when user select period where there was positions" do
      visit car_path(@car) 
