  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested subscription" do
        ...
        Subscription.any_instance.should_receive(:update).with({ "email" => "MyString" })
        put :update, {:id => subscription.to_param, :subscription => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the subscription as @subscription" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Subscription.any_instance.stub(:save).and_return(false)
        put :update, {:id => subscription.to_param, :subscription => { "email" => "invalid value" }}, valid_session
        assigns(:subscription).should eq(subscription)
      end
