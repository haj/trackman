...
describe ParametersController do
  ...
  describe "GET show" do
    it "assigns the requested parameter as @parameter" do
      ...
      assigns(:parameter).should eq(parameter)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new parameter as @parameter" do
      ...
      assigns(:parameter).should be_a_new(Parameter)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created parameter as @parameter" do
        post :create, {:parameter => valid_attributes}, valid_session
        assigns(:parameter).should be_a(Parameter)
        assigns(:parameter).should be_persisted
      end

      it "redirects to the created parameter" do
        post :create, {:parameter => valid_attributes}, valid_session
        response.should redirect_to(Parameter.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved parameter as @parameter" do
        ...
        Parameter.any_instance.stub(:save).and_return(false)
        post :create, {:parameter => { "name" => "invalid value" }}, valid_session
        assigns(:parameter).should be_a_new(Parameter)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested parameter" do
        parameter = Parameter.create! valid_attributes
        # Assuming there are no other parameters in the database, this
        # specifies that the Parameter created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Parameter.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => parameter.to_param, :parameter => { "name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the parameter" do
        parameter = Parameter.create! valid_attributes
        put :update, {:id => parameter.to_param, :parameter => valid_attributes}, valid_session
        response.should redirect_to(parameter)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the parameter as @parameter" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Parameter.any_instance.stub(:save).and_return(false)
        put :update, {:id => parameter.to_param, :parameter => { "name" => "invalid value" }}, valid_session
        assigns(:parameter).should eq(parameter)
      end
