  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved alarm as @alarm" do
        ...
        post :create, {:alarm => { "name" => "invalid value" }}, valid_session
        assigns(:alarm).should be_a_new(Alarm)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested alarm" do
        ...
        Alarm.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => alarm.to_param, :alarm => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the alarm as @alarm" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Alarm.any_instance.stub(:save).and_return(false)
        put :update, {:id => alarm.to_param, :alarm => { "name" => "invalid value" }}, valid_session
        assigns(:alarm).should eq(alarm)
      end
