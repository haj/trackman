...
describe CarModelsController do
  ...
  describe "GET index" do
    it "assigns all car_models as @car_models" do
      ...
      assigns(:car_models).should eq([car_model])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested car_model as @car_model" do
      ...
      assigns(:car_model).should eq(car_model)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new car_model as @car_model" do
      ...
      assigns(:car_model).should be_a_new(CarModel)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created car_model as @car_model" do
        post :create, {:car_model => valid_attributes}, valid_session
        assigns(:car_model).should be_a(CarModel)
        assigns(:car_model).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved car_model as @car_model" do
        ...
        post :create, {:car_model => { "name" => "invalid value" }}, valid_session
        assigns(:car_model).should be_a_new(CarModel)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested car_model" do
        car_model = CarModel.create! valid_attributes
        # Assuming there are no other car_models in the database, this
        # specifies that the CarModel created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        CarModel.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => car_model.to_param, :car_model => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the car_model as @car_model" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        CarModel.any_instance.stub(:save).and_return(false)
        put :update, {:id => car_model.to_param, :car_model => { "name" => "invalid value" }}, valid_session
        assigns(:car_model).should eq(car_model)
      end
