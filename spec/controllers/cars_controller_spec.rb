...
describe CarsController do
  ...
  let(:valid_attributes) { { "mileage" => "1.5" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved car as @car" do
        ...
        post :create, {:car => { "mileage" => "invalid value" }}, valid_session
        assigns(:car).should be_a_new(Car)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested car" do
        ...
        Car.any_instance.should_receive(:update).with({ "mileage" => "1.5" })
        put :update, {:id => car.to_param, :car => { "mileage" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the car as @car" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Car.any_instance.stub(:save).and_return(false)
        put :update, {:id => car.to_param, :car => { "mileage" => "invalid value" }}, valid_session
        assigns(:car).should eq(car)
      end
