module CarsHelper
	...
	def list_available_drivers
		return select_tag('driver_id', content_tag(:option,'Select Driver ...', :value=>"")+options_from_collection_for_select(User.available_drivers, 'id', 'name'))
	end

	def list_no_available_drivers
		return select_tag('driver_id', content_tag(:option,'No available drivers', :value=>""))
	end
